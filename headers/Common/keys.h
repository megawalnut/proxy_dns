...
namespace Keys {
    ...
    static constexpr inline const char* QUERRY_TYPES = "querry_rypes";
    ...
    static constexpr inline const char* QUERRY_TYPES_TYPE    = "querry_rypes_type";
    static constexpr inline const char* QUERRY_TYPES_PERCENT = "uerry_rypes_percent";
